  ...
  <body>
    ...
    <section class="section bg-light">
      ...
      <div class="container">
        ...
        <div id="family" class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="200">
        ...
        <div id="predential" class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="100">
