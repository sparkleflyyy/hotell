      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="rooms.html#single" class="room">
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="rooms.html#family" class="room">
              <figure class="img-wrap">
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="rooms.html#predential" class="room">
              <figure class="img-wrap">
        ...
        <div class="row">
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              ...
              <blockquote>
                <p>
                  &ldquo;Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of
                  Grammar.&rdquo;
                </p>
              </blockquote>
            ...
            <div class="testimonial text-center slider-item">
              ...
              <blockquote>
                <p>
                  &ldquo;When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line
                  Lane.&rdquo;
                </p>
              </blockquote>
              <p><em>&mdash; John Doe</em></p>
